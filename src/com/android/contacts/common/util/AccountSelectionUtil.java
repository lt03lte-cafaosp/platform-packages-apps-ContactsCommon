...
public class AccountSelectionUtil {
    ...
    public static void doImportFromMultiSim(Activity activity, AccountWithDataSet account,
            int selectedSim) {
    ...
    public static class SimSelectedListener
        ...
        public SimSelectedListener(Activity activity, AccountWithDataSet account) {
            mActivity = activity;
            mAccount = account;
        }
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            if (mSelectedSim != SIM_ID_INVALID) {
                doImportFromMultiSim(mActivity, mAccount, mSelectedSim);
            }
        }
    }

    private static void displaySelectSimDialog(Activity activity,
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE, activity.getString(R.string.ok),
                simSelListner);
